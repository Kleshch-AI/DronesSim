...
## Known bugs
- [x] Первые пару секунд игры дроны не сталкиваются.
...
- [ ] Избавиться от Physics2D.OverlapCircleAll в каждом Update: кешировать найденные препятствия в SteeringBehaviourController.GetSeparationForce(), обновлять по подписке на событие о спавне/удалении дронов.
